...
const Header = () => {
  ...
  useEffect(() => {
    ...
    // Leer el tema actual del DOM (ya aplicado por el script)
  ...
  // No renderizar el botón de tema hasta que esté hidratado en el cliente
  if (!isClient) {
    return (
        ...
        <div className="grid grid-cols-3 items-center px-4 py-1">
          ...
          <div className="flex items-center justify-end space-x-2">
            <div className="relative">
              <button className="flex items-center space-x-2 p-2 rounded-md hover-bg transition-colors cursor-pointer">
